({
    ...
    createComponent: function (cloneCmp, billing, isFirstRecord) {
        ...
        $A.createComponent(
            "c:MassiveUpdateConsolBillItemV2",
            {
                id: isFirstRecord ? '' : billing.Id,
                'aura:id': 'massiveUpdateConsolBillItemV2',
                isFirstRecord,
                isSelling,
                parent: cloneCmp,
            ...
            (massiveUpdateConsolBillItemV2, status, errorMessage) => {
                if (status === "SUCCESS") {
                    var body = cloneCmp.get("v.body");
                    body.push(massiveUpdateConsolBillItemV2);
    ...
    onToggleSelect: function (cmp, isSelected) {
        var cmps = cmp.find('massiveUpdateConsolBillItemV2'), formattedCmps = [];
        var allRecords = [];
