({
    ...
    createComponent: function (cloneCmp, billing, isFirstRecord) {
        ...
        $A.createComponent(
            "c:MassUpdateBillingItem",
            {
                id: billing.Id,
                'aura:id': 'massUpdateBillingItem',
                isFirstRecord,
                isSelling,
                parent: cloneCmp,
            ...
            (massUpdateBillingItem, status, errorMessage) => {
                if (status === "SUCCESS") {
                    var body = cloneCmp.get("v.body");
                    body.push(massUpdateBillingItem);
    ...
    onToggleSelect: function (cmp, isSelected) {
        var cmps = cmp.find('massUpdateBillingItem'), formattedCmps = [];
        var allRecords = [];
